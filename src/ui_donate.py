...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelTypeOfTheDayTitle.sizePolicy().hasHeightForWidth())
        self.labelTypeOfTheDayTitle.setSizePolicy(sizePolicy)
        self.labelTypeOfTheDayTitle.setMaximumSize(QtCore.QSize(16777215, 40))
        ...
        self.toolButtonPrevious = QtWidgets.QToolButton(self.groupBox)
        ...
        self.horizontalLayout_2.addWidget(self.labelTipOfTheDay)
        self.toolButtonNext = QtWidgets.QToolButton(self.groupBox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.toolButtonPrevious.setText(_translate("Dialog", "..."))
        ...
        self.toolButtonNext.setText(_translate("Dialog", "..."))
